                ...
                spawn!("simple_scheduler_task_worker_matching", async move {
                    ...
                    loop {
                        ...
                        if enable_batch_worker_matching {
                            ...
                            // Original notification-based approach for sequential mode, with a
                            // periodic fallback re-match for missed notifications and
                            // eventually consistent backends (see `fallback_match_interval_s`).
